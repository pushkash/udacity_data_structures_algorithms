...
class Graph:
    ...
    def get_adjacency_list(self):
        ...
        #         if index == edge.node_from.value:
        #             index_to_list.append((edge.node_to.value, edge.value))
        #     if index_to_list:
        #         adjacency_list[index] = index_to_list
    ...
    def get_adjacency_matrix(self):
        ...
        #     for to_node in range(len(self.nodes) + 1):
        #         for edge in self.edges:
        #             if edge.node_from.value == index and edge.node_to.value == to_node:
        #                 row[to_node] = edge.value
        #     matrix.append(row)
        # return matrix
